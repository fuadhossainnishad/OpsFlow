...
namespace OpsFlow.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260925134639_AddTimeEntries")]
            ...
            modelBuilder.Entity("OpsFlow.Domain.Authorization.RolePermission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PermissionId = new Guid("71000000-0000-0000-0000-000000000015")
                        },
                        new
                        {
                            RoleId = new Guid("11111111-1111-1111-1111-111111111111"),
                        ...
                        {
                            RoleId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PermissionId = new Guid("71000000-0000-0000-0000-000000000020")
                        },
                        new
                        {
                            RoleId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PermissionId = new Guid("71000000-0000-0000-0000-000000000021")
                        },
                        new
                        {
                            RoleId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PermissionId = new Guid("71000000-0000-0000-0000-000000000022")
                        },
                        new
                        {
                            RoleId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PermissionId = new Guid("71000000-0000-0000-0000-000000000023")
                        },
                        new
                        {
