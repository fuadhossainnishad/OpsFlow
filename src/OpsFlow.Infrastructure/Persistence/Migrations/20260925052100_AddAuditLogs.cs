        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BeforeJson = table.Column<string>(type: "nvarchar(max)", maxLength: 10000, nullable: true),
                    AfterJson = table.Column<string>(type: "nvarchar(max)", maxLength: 10000, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_OrganizationId_Resource_ResourceId",
                table: "AuditLogs",
                columns: new[] { "OrganizationId", "Resource", "ResourceId" });
        }
