...
namespace OpsFlow.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260926173854_SeedApprovalPermissions")]
    partial class SeedApprovalPermissions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpsFlow.Domain.Authorization.RolePermission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PermissionId = new Guid("77777777-7777-7777-7777-777777777778")
                        },
                        new
                        {
                            RoleId = new Guid("11111111-1111-1111-1111-111111111111"),
                            PermissionId = new Guid("77777777-7777-7777-7777-777777777779")
                        },
                        new
                        {
            ...
            modelBuilder.Entity("OpsFlow.Domain.Files.FileRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
